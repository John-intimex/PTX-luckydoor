...
<div class="warper" id="printArea">
    ...
    <div class="Inner" id="print" ref="print">
        <div class="left">
                <p class="HeadTitle"><span class="Request">{{$t('Enquiry.QuotationList')}}: {{ruleForm.CustomerView.ClientCode }}</span><span class="status">{{$t('Enquiry.Status')}}:{{ruleForm.CaseView.CaseStatusName}}</span></p>
                <div class="TableA" style="padding-top:15px;">
                    <ul>
                        ...
                        <li>
                            <span class="w15">{{$t('Enquiry.QuotationNo')}}:</span>
                ...
                <div class="TableA">
                 ...
                 <div class="TableA Recipient">
                    ...
                    <h2 class="NegotiationBoxTitle">{{$t('Enquiry.MessageHistory')}}</h2>
