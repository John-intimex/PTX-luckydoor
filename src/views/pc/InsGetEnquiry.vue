                ...
                <ul>
                    <li class="NoramlLi" v-for="(v,index) in ruleForm.DetailList" :key="index">
                        ...
                        <span class="w20 NormalText">
                             <el-form-item>
                                <em class="text w30">{{$t('Enquiry.Quantity')}}:</em>
                                <em class="text w70"><el-input-number v-model="v.Qty" :min="v.negotiateMinQty"  label="" :disabled="isPreview"></el-input-number></em>
                            </el-form-item>
                        </span>
                    </li>
                </ul>
