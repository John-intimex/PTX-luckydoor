...
@Component({
  components: {
    ...
    HkFlowchart: () => import('@/components/hkTasteBusiness/mobile/home/HkFlowchart.vue'),
    HkCompanyprofile: () => import('@/components/hkTasteBusiness/mobile/home/HkCompanyprofile.vue'),
